...
clear
echo "Grabbing the latest Google Web Fonts tarball from Github"
echo "Downloading..."
...
echo "All done! All Google Fonts installed. Remember to Disable Fonts you don't use with FontBook on Mac, or another tools like FontAgent or FontExplorer X."
